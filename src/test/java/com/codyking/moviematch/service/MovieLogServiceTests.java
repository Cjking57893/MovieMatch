...
public class MovieLogServiceTests {
  ...
  @Mock private MovieLogRepository movieLogRepository;

  @InjectMocks private MovieLogService movieLogService;
  ...
  void testGetMovieLogById() {
    ...
    when(movieLogRepository.findById(10L))
        .thenReturn(
            Optional.of(fakeMovieLog1)); // Returning as optional since that is findByID return type
  ...
  void testUpdateMovieLog() {
    ...
    assertThrows(
        RuntimeException.class, () -> movieLogService.updateMovieLog(2L, updatedFakeMovieLog1));
  ...
  void testDeleteMovieLog() {
    ...
    assertThrows(RuntimeException.class, () -> movieLogService.deleteMovieLog(2L));
