...
public class TvShowLogServiceTests {
  @Mock private TvShowLogRepository tvShowLogRepository;

  @InjectMocks private TvShowLogService tvShowLogService;
  ...
  void testGetTvShowLogById() {
    ...
    when(tvShowLogRepository.findById(10L))
        .thenReturn(
            Optional.of(
                fakeTvShowLog1)); // Returning as optional since that is findByID return type
  ...
  void testUpdateTvShowLog() {
    ...
    TvShowLog result =
        tvShowLogService.updateTvShowLog(fakeTvShowLog1.getId(), updatedFakeTvShowLog1);

    assertThrows(
        RuntimeException.class, () -> tvShowLogService.updateTvShowLog(2L, updatedFakeTvShowLog1));
  ...
  void testDeleteTvShowLog() {
    ...
    assertThrows(RuntimeException.class, () -> tvShowLogService.deleteTvShowLog(2L));
