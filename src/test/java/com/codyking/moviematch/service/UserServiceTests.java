...
public class UserServiceTests {
    ...
    void testGetUserById() {
        ...
        when(userRepository.findById(10L)).thenReturn(Optional.of(fakeUser1)); // Returning as optional since that is findByID return type
    ...
    void testUpdateUser() {
        ...
        assertThrows(RuntimeException.class, () ->
                userService.updateUser(2L, updatedFakeUser1)
        );
